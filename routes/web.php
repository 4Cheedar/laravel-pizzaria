...
Route::get('/gerenciarPedidos', function () {
    // App::setLocale(Session::get('idioma', Config::get('app.locale')));
     return view('Pedidos/gerenciarPedidos');
 })->name('Gerenciar');
...
Route::get('/pedido/usuario', "App\Http\Controllers\PedidoUsuarioController@index")->name("pedido.usuario.index");
...
Route::get('idioma/{idioma}', "App\Http\Controllers\IdiomaController@trocaIdioma")->name("idioma.trocaIdioma");
