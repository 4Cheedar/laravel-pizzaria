...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <a class="btn btn-primary" href="<?php echo e(route("tipoproduto.create")); ?>"><?php echo e(__('welcome_dashboards.btnCreateTypeProduct')); ?></a>
        <a class="btn btn-primary" href="<?php echo e(route("admin.dashboard")); ?>"><?php echo e(__('welcome_dashboards.btnBack')); ?></a>
        <table class="table table-hover">
            <thead>
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col"><?php echo e(__('welcome_dashboards.description')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $tipoProdutos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoProduto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="<?php echo e(route("tipoproduto.show", $tipoProduto->id)); ?>"><?php echo e(__('welcome_dashboards.btnShow')); ?></a>
                            <a class="btn btn-secondary" href="<?php echo e(route("tipoproduto.edit", $tipoProduto->id)); ?>"><?php echo e(__('welcome_dashboards.btnEdit')); ?></a>
                            <a href="#" class="btn btn-danger btn-remover" data-bs-toggle="modal" data-bs-target="#id-remove-modal" value="<?php echo e(route("tipoproduto.destroy", $tipoProduto->id)); ?>"><?php echo e(__('welcome_dashboards.btnRemove')); ?></a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iaguc\Desktop\IFSC\IFSC Projetos\Trabalhos\ProjetoAula2\resources\views/TipoProduto/index.blade.php ENDPATH**/ ?>